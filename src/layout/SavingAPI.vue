			...
			<div class="bg-[#FFFFFF] custom-shadow-right">
				...
				<div v-if="StaffDropdownOpen" class="ml-[40px] mt-2">
					...
					<!-- <router-link to="/benefit"
						...
						<div class="py-[10px] mx-[10px]">
							<p class="siemreap-regular text-[18px]">អត្ថប្រយោជន៍</p>
						</div>
					</router-link> -->
				...
				<!-- <router-link to="/report"
					class="hover:bg-[#00992B]  my-2 text-[#00992B] hover:text-white rounded-s-md ml-[20px] flex group relative">
					<div class="p-[10px] w-[50px]">
						<i class="fa-solid fa-sheet-plastic text-[20px] text-[#00992B]"></i>
					</div>
					<div class="py-[10px] mx-[10px]">
						<p class="siemreap-regular text-[18px]">របាយការណ៍</p>
					</div>
				</router-link> -->
				...
				<div v-if="UserDropdownOpen" class="ml-[40px] mt-2">
					...
					<router-link to="/role"
						...
						<div class="py-[10px] mx-[10px]">
							<p class="siemreap-regular text-[18px]">សិទ្ធអ្នកប្រើប្រាស់</p>
						</div>
					</router-link>
				</div>
			</div>
...
export default {
	...
	methods: {
		...mapActions(['logout', 'loadUserFromStorage']),
