<template>
	<div class="bg-white shadow-md h-screen rounded-lg">
		<p class="p-5 text-lg font-semibold underline text-[#00992B] moul-regular">សំណើរដែលបានដាក់</p>
			...
			<table class="w-full table-radius text-sm text-left text-gray-500">
				...
				<tbody>
					<tr v-for="(item, index) in paginatedItems" :key="item.id"
						...
						<td class="px-6 border text-nowrap border-gray-200 py-3 text-center text-green-500"> បានដាក់ជូន</td>
